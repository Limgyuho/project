...
<div class="flex justify-center items-center mb-48">
    <div>
        <div class="flex px-10 w-full mb-16">
            <button class="px-10 py-5 hover:bg-blue-200 mx-10 border-black bg-blue-500 text-white font-bold" onclick="showTab('운영지원과')">운영지원과</button>
            <button class="px-10 py-5 hover:bg-blue-200 mx-10 border-black bg-blue-500 text-white font-bold" onclick="showTab('기획재정담당관')">기획재정담당관</button>
            <button class="px-10 py-5 hover:bg-blue-200 mx-10 border-black bg-blue-500 text-white font-bold" onclick="showTab('감사과')">감사과</button>
            <button class="px-10 py-5 hover:bg-blue-200 mx-10 border-black bg-blue-500 text-white font-bold" onclick="showTab('정보과')">정보과</button>
        </div>
                    ...
                    <table class="w-full bg-white border border-gray-200">
                        <thead>
                            <tr class="bg-gray-100">
                                ...
                                <th class="py-2 px-4 border-b">직급</th>
                            ...
                            <c:forEach var="member" items="${approvedMembers}">
                                <c:if test="${member.department == '운영지원과'}">
                                    <tr>
                                        ...
                                        <td class="py-2 px-4 border-b">${member.cellphoneNum}</td>
                                    </tr>
                                </c:if>
                            </c:forEach>
                        </tbody>
