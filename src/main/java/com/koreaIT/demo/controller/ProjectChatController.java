...
public class ProjectChatController {
    ...
    @MessageMapping("/usr/chat/enterUser")
    public void enterUser(@Payload ChatDTO chat, SimpMessageHeaderAccessor headerAccessor) {
        ...
        template.convertAndSend("/sub/usr/chat/enterRoom/" + chat.getRoomId(), chat);
    ...
    public void webSocketDisconnectListener(SessionDisconnectEvent event) {
        ...
        if (username != null) {
            ...
            template.convertAndSend("/sub/usr/chat/enterRoom/" + roomId, chat);
        }
    }

    // 채팅에 참여한 유저 리스트 반환
    @GetMapping("/usr/chat/userlist")
    @ResponseBody
    ...
    @GetMapping("/usr/chat/duplicateName")
    @ResponseBody
