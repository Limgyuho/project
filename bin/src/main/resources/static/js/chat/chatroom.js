...
function onConnected() {
    ...
    stompClient.subscribe('/sub/usr/chat/enterRoom/' + roomId, onMessageReceived);

    // 서버에 username 을 가진 유저가 들어왔다는 것을 알림
    // /pub/project/chat/enterUser 로 메시지를 보냄
    stompClient.send("/pub/usr/chat/enterUser",
        {},
        JSON.stringify({
            "roomId": roomId,
            sender: username,
